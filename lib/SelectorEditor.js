(function (global, factory) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-2709406306", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-2709406306-style';
		style.textContent = "[svelte-2709406306].selector,[svelte-2709406306] .selector{margin:.5em;padding:.5em;display:flex;flex-direction:column;border:1px dotted}[svelte-2709406306].selector .clause,[svelte-2709406306] .selector .clause,[svelte-2709406306].selector .clause .clause-entry,[svelte-2709406306] .selector .clause .clause-entry{padding:.5em 1em;display:flex;flex-direction:row}";
	...
	function click_handler(event) {
		...
		var clausesKeysTypes_1 = this._svelte.clausesKeysTypes_1,
		    ...
		    clause_1 = clausesKeysTypes_1[clause_index];
	...
	function click_handler_2(event) {
		...
		var each_value = this._svelte.each_value,
		    index = this._svelte.index,
		    clauseEntry_1 = each_value[index];
		component.removeClauseEntry(clause_1.key, index);
	}
	...
	function SelectorEditor(options) {
		...
		if (!document.getElementById("svelte-2709406306-style")) add_css();
